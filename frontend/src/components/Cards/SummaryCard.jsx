  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, ${colors.bgcolor || "#6366F1"}, ${
            colors.gradient || "#A78BFA"
          })`,
        }}
      >
        {/* Avatar */}
        ...
        <button
          className="hidden group-hover:flex items-center gap-1.5 
                     text-xs text-rose-600 font-medium bg-white/80 
                     px-2.5 py-1 rounded-lg border border-rose-200 
                     hover:bg-white absolute top-3 right-3"
          onClick={(e) => {
            e.stopPropagation();
            onDelete();
          }}
      ...
      <div className="px-5 py-4">
        ...
        {/* Description */}
        <p className="text-sm text-gray-700 leading-relaxed line-clamp-3 mt-3">
          {description}
        </p>
      </div>
    </div>
