...
// Mock data for features - we'll need to create this
const APP_FEATURES = [
  {
    id: 1,
  ...
  },
  {
    ...
    description: "Receive instant feedback on your answers to improve your interview performance."
  },
  {
    id: 3,
    title: "Practice Sessions",
    description: "Create unlimited practice sessions tailored to specific job roles and industries."
  },
  {
    id: 4,
  ...
  },
  {
    id: 5,
    title: "Expert Tips",
    description: "Access professional interview tips and strategies from industry experts."
  },
  {
    id: 6,
    title: "Mock Interviews",
    description: "Simulate real interview scenarios to build confidence and reduce anxiety."
  }
];
      ...
      <div className="relative w-full min-h-screen overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-pink-50">
        ...
        <div className="container mx-auto px-4 pt-6 relative z-10">
          ...
          <header className="flex justify-between items-center mb-16">
            ...
            {user ? (
              <div className="text-sm text-gray-600 gap-2 flex items-center">Welcome, {user.name}
              <button
              onClick={handleLogout}
             className="bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white px-5 py-2 rounded-full text-sm md:text-base font-semibold shadow-xl hover:scale-105 hover:shadow-2xl transition-all duration-300 animate-gradient"
            >
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20">
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full h-[400px] bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl shadow-2xl border border-purple-100 hover:scale-105 transition-transform duration-500 flex items-center justify-center">
                <Image src={image} alt="Hero" className="w-full h-full object-contain" />
              </div>
            </div>
          </div>
        </div>
