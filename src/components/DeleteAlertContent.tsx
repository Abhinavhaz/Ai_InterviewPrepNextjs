...
const DeleteAlertContent: React.FC<DeleteAlertContentProps> = ({ content, onConfirm, onClose }) => {
  return (
    <div className="flex flex-col gap-5 p-4 md:p-6 text-center">
      ...
      {/* Title + Message */}
      <div>
        <h2 className="text-lg md:text-xl font-semibold text-gray-900">Are you sure?</h2>
