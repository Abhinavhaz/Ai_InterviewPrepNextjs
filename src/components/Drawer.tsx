      ...
      >
        ...
        <div className="flex justify-between items-center p-4 border-b border-gray-300 bg-gradient-to-r from-cyan-100 to-white rounded-tl-lg">
          ...
          <button
            type="button"
            onClick={onClose}
            className="text-gray-500 hover:text-white hover:bg-red-500 rounded-full w-8 h-8 flex items-center justify-center transition-all duration-200"
          >
        ...
        <div className="p-4 border-t border-gray-200 bg-gradient-to-r from-white to-gray-50 flex justify-end rounded-bl-lg">
          <button
            onClick={handleCopy}
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-cyan-600 text-cyan-700 font-medium hover:bg-cyan-600 hover:text-white transition-all duration-200 shadow-sm"
          >
